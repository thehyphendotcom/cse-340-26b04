 ...
 * @param {string|Date} date - The project date.
 * @param {number|string} organizationId - The associated organization ID.
...
const getVolunteeredProjectsByUserId = async (userId) => {
    const query = `
        SELECT p.project_id, p.title, p.description, p.location, p.project_date AS date, o.name AS organization_name
        FROM projects p
